...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        String[] strings = to_split.split("\\s");
        ret.append(strings[0].charAt(0));
        ret.append(strings[1].charAt(0));
        ret.append(strings[2].charAt(0));
        ret.append(strings[3].charAt(0));
        ret.append(strings[4].charAt(0));
        ret.append(strings[5].charAt(0));
        ret.append(strings[6].charAt(0));
